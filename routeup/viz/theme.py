...
.. doctest::
    ...
    >>> chart = bars + text
    >>> chart.save(
    ...     config.PATH_DATA_RESULTS / "altair_example_barh.html"
    ... )
...
class Theme(_Base):
    ...
    """Custom font weight."""
    legend_font_weight: str = "lighter"
    ...
    def _get_mpl_theme(self) -> dict[str, Any]:
        ...
        return {
            ...
            "axes.labelsize": self.font_size_sm,
    ...
    def disable(self, which: Literal["all", "alt", "mpl"] = "all"):
